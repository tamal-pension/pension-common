...
public class YearlyV02Model implements YearlyModel {

	@XmlElement(name = "KoteretKovetz", required = true)
	protected YearlyV02Model.KoteretKovetz koteretKovetz;
	...
	@Override
	public YearlyV02Model.KoteretKovetz getKoteretKovetz() {
		return koteretKovetz;
	}

	public void setKoteretKovetz(YearlyV02Model.KoteretKovetz value) {
	...
	public static class GufHamimshak implements GufHamimshakBase {
		...
		protected List<YearlyV02Model.GufHamimshak.YeshutGoremPoneLemislaka> yeshutGoremPoneLemislaka;

		@Override
		public List<YearlyV02Model.GufHamimshak.YeshutGoremPoneLemislaka> getYeshutGoremPoneLemislaka() {
			if (yeshutGoremPoneLemislaka == null) {
				yeshutGoremPoneLemislaka = new ArrayList<YearlyV02Model.GufHamimshak.YeshutGoremPoneLemislaka>();
			}
		...
		public static class YeshutGoremPoneLemislaka implements YeshutGoremPoneLemislakaBase {
			...
			protected List<YearlyV02Model.GufHamimshak.YeshutGoremPoneLemislaka.StatosPirteiHaavaratKsafim> statosPirteiHaavaratKsafim;
			...
			@Override
			public List<YearlyV02Model.GufHamimshak.YeshutGoremPoneLemislaka.StatosPirteiHaavaratKsafim> getStatosPirteiHaavaratKsafim() {
				if (statosPirteiHaavaratKsafim == null) {
					statosPirteiHaavaratKsafim = new ArrayList<YearlyV02Model.GufHamimshak.YeshutGoremPoneLemislaka.StatosPirteiHaavaratKsafim>();
				}
				return this.statosPirteiHaavaratKsafim;
			}

			@XmlAccessorType(XmlAccessType.FIELD)
			@XmlType(name = "", propOrder = { "kodmezahekupahp", "sugmezahemaasik", "misparzihuymaasik", "kodmezahemaasiketzelyatzran",
					...
					"misparmislakaacharon", "pirteiMutzar" })
			public static class StatosPirteiHaavaratKsafim implements StatosPirteiHaavaratKsafimBase {
				...
				@XmlElement(name = "MISPAR-MISLAKA-ACHARON")
				protected String misparmislakaacharon;
				@XmlElement(name = "PirteiMutzar", required = true)
				protected List<YearlyV02Model.GufHamimshak.YeshutGoremPoneLemislaka.StatosPirteiHaavaratKsafim.PirteiMutzar> pirteiMutzar;
				...
				public String getMISPARMISLAKAACHARON() {
					return misparmislakaacharon;
				}
				
				public void setMISPARMISLAKAACHARON(String value) {
					this.misparmislakaacharon = value;
				}

				@Override
				public List<YearlyV02Model.GufHamimshak.YeshutGoremPoneLemislaka.StatosPirteiHaavaratKsafim.PirteiMutzar> getPirteiMutzar() {
					if (pirteiMutzar == null) {
						pirteiMutzar = new ArrayList<YearlyV02Model.GufHamimshak.YeshutGoremPoneLemislaka.StatosPirteiHaavaratKsafim.PirteiMutzar>();
					}
					return this.pirteiMutzar;
				}

				@XmlAccessorType(XmlAccessType.FIELD)
				@XmlType(name = "", propOrder = { "sugmutzar", "sugkerenpensia",
				...
				public static class PirteiMutzar implements PirteiMutzarBase {
					...
					protected List<YearlyV02Model.GufHamimshak.YeshutGoremPoneLemislaka.StatosPirteiHaavaratKsafim.PirteiMutzar.PirteiOved> pirteiOved;
					...
					@Override
					public List<YearlyV02Model.GufHamimshak.YeshutGoremPoneLemislaka.StatosPirteiHaavaratKsafim.PirteiMutzar.PirteiOved> getPirteiOved() {
						if (pirteiOved == null) {
							pirteiOved = new ArrayList<YearlyV02Model.GufHamimshak.YeshutGoremPoneLemislaka.StatosPirteiHaavaratKsafim.PirteiMutzar.PirteiOved>();
						}
					...
					public static class PirteiOved implements PirteiOvedBase {
						...
						protected List<YearlyV02Model.GufHamimshak.YeshutGoremPoneLemislaka.StatosPirteiHaavaratKsafim.PirteiMutzar.PirteiOved.SachHafkadotShnatiot> sachHafkadotShnatiot;
						...
						@Override
						public List<YearlyV02Model.GufHamimshak.YeshutGoremPoneLemislaka.StatosPirteiHaavaratKsafim.PirteiMutzar.PirteiOved.SachHafkadotShnatiot> getSachHafkadotShnatiot() {
							if (sachHafkadotShnatiot == null) {
								sachHafkadotShnatiot = new ArrayList<YearlyV02Model.GufHamimshak.YeshutGoremPoneLemislaka.StatosPirteiHaavaratKsafim.PirteiMutzar.PirteiOved.SachHafkadotShnatiot>();
							}
							return this.sachHafkadotShnatiot;
						}

						@XmlAccessorType(XmlAccessType.FIELD)
						@XmlType(name = "", propOrder = { "misparpolisaoheshbon", "sughafrasha",
	...
	public static class KoteretKovetz implements KoteretKovetzBase {
		...
		protected YearlyV02Model.KoteretKovetz.NetuneiGoremSholech netuneiGoremSholech;
		@XmlElement(name = "NetuneiGoremNimaan", required = true)
		protected YearlyV02Model.KoteretKovetz.NetuneiGoremNimaan netuneiGoremNimaan;
		...
		@Override
		public YearlyV02Model.KoteretKovetz.NetuneiGoremSholech getNetuneiGoremSholech() {
			return netuneiGoremSholech;
		}

		public void setNetuneiGoremSholech(YearlyV02Model.KoteretKovetz.NetuneiGoremSholech value) {
			this.netuneiGoremSholech = value;
		}

		@Override
		public YearlyV02Model.KoteretKovetz.NetuneiGoremNimaan getNetuneiGoremNimaan() {
			return netuneiGoremNimaan;
		}

		public void setNetuneiGoremNimaan(YearlyV02Model.KoteretKovetz.NetuneiGoremNimaan value) {
