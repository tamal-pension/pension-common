...
public class NegativeV04Model implements NegativeModel {

	@XmlElement(name = "KoteretKovetz", required = true)
	protected NegativeV04Model.KoteretKovetz koteretKovetz;
	@XmlElement(name = "GufHamimshak", required = true)
	protected GufHamimshak gufHamimshak;
	@XmlElement(name = "ReshumatSgira", required = true)
	protected NegativeV04Model.ReshumatSgira reshumatSgira;

	@Override
	public NegativeV04Model.KoteretKovetz getKoteretKovetz() {
		return koteretKovetz;
	}

	public void setKoteretKovetz(NegativeV04Model.KoteretKovetz value) {
	...
	@Override
	public NegativeV04Model.ReshumatSgira getReshumatSgira() {
		return reshumatSgira;
	}

	public void setReshumatSgira(NegativeV04Model.ReshumatSgira value) {
	...
	public static class GufHamimshak implements GufHamimshakBase {
		...
		protected List<NegativeV04Model.GufHamimshak.YeshutGoremPoneLemislaka> yeshutGoremPoneLemislaka;

		@Override
		public List<NegativeV04Model.GufHamimshak.YeshutGoremPoneLemislaka> getYeshutGoremPoneLemislaka() {
			if (yeshutGoremPoneLemislaka == null) {
				yeshutGoremPoneLemislaka = new ArrayList<NegativeV04Model.GufHamimshak.YeshutGoremPoneLemislaka>();
			}
		...
		public static class YeshutGoremPoneLemislaka implements YeshutGoremPoneLemislakaBase {
			...
			protected List<NegativeV04Model.GufHamimshak.YeshutGoremPoneLemislaka.PirteiHaavaratKsafim> pirteiHaavaratKsafim;
			...
			@Override
			public List<NegativeV04Model.GufHamimshak.YeshutGoremPoneLemislaka.PirteiHaavaratKsafim> getPirteiHaavaratKsafim() {
				if (pirteiHaavaratKsafim == null) {
					pirteiHaavaratKsafim = new ArrayList<NegativeV04Model.GufHamimshak.YeshutGoremPoneLemislaka.PirteiHaavaratKsafim>();
				}
			...
			public static class PirteiHaavaratKsafim implements PirteiHaavaratKsafimBase {
				...
				@XmlElement(name = "MISPAR-TIK-NIKUIM-MAASIK", required = true, nillable = true)
				...
				@XmlElement(name = "MISPAR-ZIHUI", required = true)
				...
				protected List<NegativeV04Model.GufHamimshak.YeshutGoremPoneLemislaka.PirteiHaavaratKsafim.ZihuiShemMismachBeramatEirua> zihuiShemMismachBeramatEirua;
				@XmlElement(name = "PirteiKupa")
				protected List<NegativeV04Model.GufHamimshak.YeshutGoremPoneLemislaka.PirteiHaavaratKsafim.PirteiKupa> pirteiKupa;
				...
				@Override
				public List<NegativeV04Model.GufHamimshak.YeshutGoremPoneLemislaka.PirteiHaavaratKsafim.ZihuiShemMismachBeramatEirua> getZihuiShemMismachBeramatEirua() {
					if (zihuiShemMismachBeramatEirua == null) {
						zihuiShemMismachBeramatEirua = new ArrayList<NegativeV04Model.GufHamimshak.YeshutGoremPoneLemislaka.PirteiHaavaratKsafim.ZihuiShemMismachBeramatEirua>();
					}
					return this.zihuiShemMismachBeramatEirua;
				}

				@Override
				public List<NegativeV04Model.GufHamimshak.YeshutGoremPoneLemislaka.PirteiHaavaratKsafim.PirteiKupa> getPirteiKupa() {
					if (pirteiKupa == null) {
						pirteiKupa = new ArrayList<NegativeV04Model.GufHamimshak.YeshutGoremPoneLemislaka.PirteiHaavaratKsafim.PirteiKupa>();
					}
				...
				public static class PirteiKupa implements PirteiKupaBase {
					...
					protected List<NegativeV04Model.GufHamimshak.YeshutGoremPoneLemislaka.PirteiHaavaratKsafim.PirteiKupa.PirteiOved> pirteiOved;
					...
					@Override
					public List<NegativeV04Model.GufHamimshak.YeshutGoremPoneLemislaka.PirteiHaavaratKsafim.PirteiKupa.PirteiOved> getPirteiOved() {
						if (pirteiOved == null) {
							pirteiOved = new ArrayList<NegativeV04Model.GufHamimshak.YeshutGoremPoneLemislaka.PirteiHaavaratKsafim.PirteiKupa.PirteiOved>();
						}
					...
					public static class PirteiOved implements PirteiOvedBase {
						...
						protected List<NegativeV04Model.GufHamimshak.YeshutGoremPoneLemislaka.PirteiHaavaratKsafim.PirteiKupa.PirteiOved.ChodeshMaskoretVestatusOved> chodeshMaskoretVestatusOved;
						...
						public void setHASHAVAKIBUTZI(Integer value) {
						...
						@Override
						public List<NegativeV04Model.GufHamimshak.YeshutGoremPoneLemislaka.PirteiHaavaratKsafim.PirteiKupa.PirteiOved.ChodeshMaskoretVestatusOved> getChodeshMaskoretVestatusOved() {
							if (chodeshMaskoretVestatusOved == null) {
								chodeshMaskoretVestatusOved = new ArrayList<NegativeV04Model.GufHamimshak.YeshutGoremPoneLemislaka.PirteiHaavaratKsafim.PirteiKupa.PirteiOved.ChodeshMaskoretVestatusOved>();
							}
						...
						public static class ChodeshMaskoretVestatusOved implements ChodeshMaskoretVestatusOvedBase {
							...
							protected List<NegativeV04Model.GufHamimshak.YeshutGoremPoneLemislaka.PirteiHaavaratKsafim.PirteiKupa.PirteiOved.ChodeshMaskoretVestatusOved.PizulHafrashotOvedBeKupa> pizulHafrashotOvedBeKupa;
							...
							@Override
							public List<NegativeV04Model.GufHamimshak.YeshutGoremPoneLemislaka.PirteiHaavaratKsafim.PirteiKupa.PirteiOved.ChodeshMaskoretVestatusOved.PizulHafrashotOvedBeKupa> getPizulHafrashotOvedBeKupa() {
								if (pizulHafrashotOvedBeKupa == null) {
									pizulHafrashotOvedBeKupa = new ArrayList<NegativeV04Model.GufHamimshak.YeshutGoremPoneLemislaka.PirteiHaavaratKsafim.PirteiKupa.PirteiOved.ChodeshMaskoretVestatusOved.PizulHafrashotOvedBeKupa>();
								}
							...
							@XmlType(name = "", propOrder = { "sughafrasha", "shiurhafrasha", "schumhafrasha",
									"misparmezahereshuma", "misparmezahereshumakodem" })
				...
				public static class ZihuiShemMismachBeramatEirua implements ZihuiShemMismachBeramatEiruaBase {
					...
					@XmlElement(name = "SHEM-KOVETZ-SHEL-MISMACH-BERAMAT-EIRUA-VEBERAMAT-LAKOACH")
	...
	public static class KoteretKovetz implements KoteretKovetzBase {
		...
		protected NegativeV04Model.KoteretKovetz.NetuneiGoremSholech netuneiGoremSholech;
		@XmlElement(name = "NetuneiGoremNimaan", required = true)
		protected NegativeV04Model.KoteretKovetz.NetuneiGoremNimaan netuneiGoremNimaan;
		...
		public NegativeV04Model.KoteretKovetz.NetuneiGoremSholech getNetuneiGoremSholech() {
			return netuneiGoremSholech;
		}

		public void setNetuneiGoremSholech(NegativeV04Model.KoteretKovetz.NetuneiGoremSholech value) {
			this.netuneiGoremSholech = value;
		}

		public NegativeV04Model.KoteretKovetz.NetuneiGoremNimaan getNetuneiGoremNimaan() {
			return netuneiGoremNimaan;
		}

		public void setNetuneiGoremNimaan(NegativeV04Model.KoteretKovetz.NetuneiGoremNimaan value) {
