...
public class FirstV06Model implements FirstModel {
	...
	public void setKoteretKovetz(FirstV06Model.KoteretKovetz value) {
	...
	public static class GufHamimshak implements GufHamimshakBase {
		...
		protected List<FirstV06Model.GufHamimshak.YeshutGoremPoneLemislaka> yeshutGoremPoneLemislaka;

		@Override
		public List<FirstV06Model.GufHamimshak.YeshutGoremPoneLemislaka> getYeshutGoremPoneLemislaka() {
			if (yeshutGoremPoneLemislaka == null) {
				yeshutGoremPoneLemislaka = new ArrayList<FirstV06Model.GufHamimshak.YeshutGoremPoneLemislaka>();
			}
		...
		public static class YeshutGoremPoneLemislaka implements YeshutGoremPoneLemislakaBase {
			...
			protected List<FirstV06Model.GufHamimshak.YeshutGoremPoneLemislaka.SugMashov> sugMashov;
			...
			@Override
			public List<FirstV06Model.GufHamimshak.YeshutGoremPoneLemislaka.SugMashov> getSugMashov() {
				if (sugMashov == null) {
					sugMashov = new ArrayList<FirstV06Model.GufHamimshak.YeshutGoremPoneLemislaka.SugMashov>();
				}
			...
			public static class SugMashov implements SugMashovBase {
				...
				protected List<FirstV06Model.GufHamimshak.YeshutGoremPoneLemislaka.SugMashov.MashovBeramatReshuma> mashovBeramatReshuma;
				...
				@Override
				public List<FirstV06Model.GufHamimshak.YeshutGoremPoneLemislaka.SugMashov.MashovBeramatReshuma> getMashovBeramatReshuma() {
					if (mashovBeramatReshuma == null) {
						mashovBeramatReshuma = new ArrayList<FirstV06Model.GufHamimshak.YeshutGoremPoneLemislaka.SugMashov.MashovBeramatReshuma>();
					}
				...
				public static class MashovBeramatKovetz implements MashovBeramatKovetzBase {
					...
					protected List<FirstV06Model.GufHamimshak.YeshutGoremPoneLemislaka.SugMashov.MashovBeramatKovetz.PerutShgihaBeramatKovetz> perutShgihaBeramatKovetz;
					...
					@Override
					public List<FirstV06Model.GufHamimshak.YeshutGoremPoneLemislaka.SugMashov.MashovBeramatKovetz.PerutShgihaBeramatKovetz> getPerutShgihaBeramatKovetz() {
						if (perutShgihaBeramatKovetz == null) {
							perutShgihaBeramatKovetz = new ArrayList<FirstV06Model.GufHamimshak.YeshutGoremPoneLemislaka.SugMashov.MashovBeramatKovetz.PerutShgihaBeramatKovetz>();
						}
				...
				@XmlType(name = "", propOrder = { "misparmislaka", "misparmezahereshuma", "statusreshuma",
						"kodshgihaberamatreshuma", "maaneMiYazran", "perutShgihaBeramatReshuma" })
				public static class MashovBeramatReshuma implements MashovBeramatReshumaBase {
					...
					protected List<FirstV06Model.GufHamimshak.YeshutGoremPoneLemislaka.SugMashov.MashovBeramatReshuma.MaaneMiYazran> maaneMiYazran;
					@XmlElement(name = "PerutShgihaBeramatReshuma")
					protected List<FirstV06Model.GufHamimshak.YeshutGoremPoneLemislaka.SugMashov.MashovBeramatReshuma.PerutShgihaBeramatReshuma> perutShgihaBeramatReshuma;
					...
					@Override
					public List<FirstV06Model.GufHamimshak.YeshutGoremPoneLemislaka.SugMashov.MashovBeramatReshuma.MaaneMiYazran> getMaaneMiYazran() {
						if (maaneMiYazran == null) {
							maaneMiYazran = new ArrayList<FirstV06Model.GufHamimshak.YeshutGoremPoneLemislaka.SugMashov.MashovBeramatReshuma.MaaneMiYazran>();
						}
						return this.maaneMiYazran;
					}

					@Override
					public List<FirstV06Model.GufHamimshak.YeshutGoremPoneLemislaka.SugMashov.MashovBeramatReshuma.PerutShgihaBeramatReshuma> getPerutShgihaBeramatReshuma() {
						if (perutShgihaBeramatReshuma == null) {
							perutShgihaBeramatReshuma = new ArrayList<FirstV06Model.GufHamimshak.YeshutGoremPoneLemislaka.SugMashov.MashovBeramatReshuma.PerutShgihaBeramatReshuma>();
						}
	...
	public static class KoteretKovetz implements KoteretKovetzBase {
		...
		protected FirstV06Model.KoteretKovetz.NetuneiGoremSholech netuneiGoremSholech;
		@XmlElement(name = "NetuneiGoremNimaan", required = true)
		protected FirstV06Model.KoteretKovetz.NetuneiGoremNimaan netuneiGoremNimaan;
		...
		@Override
		public FirstV06Model.KoteretKovetz.NetuneiGoremSholech getNetuneiGoremSholech() {
			return netuneiGoremSholech;
		}

		public void setNetuneiGoremSholech(FirstV06Model.KoteretKovetz.NetuneiGoremSholech value) {
			this.netuneiGoremSholech = value;
		}

		@Override
		public FirstV06Model.KoteretKovetz.NetuneiGoremNimaan getNetuneiGoremNimaan() {
			return netuneiGoremNimaan;
		}

		public void setNetuneiGoremNimaan(FirstV06Model.KoteretKovetz.NetuneiGoremNimaan value) {
