...
public class ShotefV04Model implements ShotefModel {
	...
	public String toString() {
		return MoreObjects.toStringHelper(this).add("koteretKovetz", koteretKovetz).add("gufHamimshak", gufHamimshak)
				.add("reshumatSgira", reshumatSgira).toString();
	}
	...
	public static class GufHamimshak implements ShotefGufHamimshak {

		@XmlElement(name = "YeshutGoremPoneLemislaka", required = true)
		protected List<ShotefV04Model.GufHamimshak.YeshutGoremPoneLemislaka> yeshutGoremPoneLemislaka;

		@Override
		public String toString() {
			return MoreObjects.toStringHelper(this).add("yeshutGoremPoneLemislaka", yeshutGoremPoneLemislaka)
					.toString();
		}

		@Override
		public List<ShotefV04Model.GufHamimshak.YeshutGoremPoneLemislaka> getYeshutGoremPoneLemislaka() {
			if (yeshutGoremPoneLemislaka == null) {
				yeshutGoremPoneLemislaka = new ArrayList<ShotefV04Model.GufHamimshak.YeshutGoremPoneLemislaka>();
			}
		...
		public static class YeshutGoremPoneLemislaka implements YeshutGoremPoneLemislakaBase {
			...
			protected List<ShotefV04Model.GufHamimshak.YeshutGoremPoneLemislaka.PirteiHaavaratKsafim> pirteiHaavaratKsafim;
			...
			@Override
			public List<ShotefV04Model.GufHamimshak.YeshutGoremPoneLemislaka.PirteiHaavaratKsafim> getPirteiHaavaratKsafim() {
				if (pirteiHaavaratKsafim == null) {
					pirteiHaavaratKsafim = new ArrayList<ShotefV04Model.GufHamimshak.YeshutGoremPoneLemislaka.PirteiHaavaratKsafim>();
				}
			...
			public static class PirteiHaavaratKsafim implements PirteiHaavaratKsafimBase {
				...
				@XmlElement(name = "MISPAR-TIK-NIKUIM-MAASIK", required = true)
				protected String mispartiknikuimmaasik;
				...
				@XmlElement(name = "SCHUM-HAFKADA-KOLEL", required = true)
				protected BigDecimal schumhafkadakolel;
				@XmlElement(name = "SHEM-MAASIK", required = true)
				protected String shemmaasik;
				@XmlElement(name = "SHEM-PRATI-ISH-KESHER-MAASIK", required = true)
				protected String shempratiishkeshermaasik;
				@XmlElement(name = "SHEM-MISHPACHA-ISH-KESHER-MAASIK", required = true)
				protected String shemmishpachaishkeshermaasik;
				@XmlElement(name = "MISPAR-TELEPHONE-KAVI-ISH-KESHER-MAASIK", required = true)
				protected String mispartelephonekaviishkeshermaasik;
				@XmlElement(name = "E-MAIL-ISH-KESHER-MAASIK", required = true)
				protected String emailishkeshermaasik;
				@XmlElement(name = "MISPAR-CELLULARI-ISH-KESHER-MAASIK", required = true, nillable = true)
				protected String misparcellulariishkeshermaasik;
				
				@XmlElement(name = "SUG-PEULA")
				protected int sugpeula;
				@XmlElement(name = "KOD-EMTZAI-TASHLUM")
				...
				@XmlElement(name = "MISPAR-BANK-MAASIK", required = true)
				protected String misparbankmaasik;
				@XmlElement(name = "MISPAR-SNIF-MAASIK", required = true)
				...
				@XmlElement(name = "SUG-CHESHBON-MAASIK")
				protected int sugcheshbonmaasik;
				@XmlElement(name = "SUG-CHESHBON-KOLET-TASHLUM")
				protected int sugcheshbonkolettashlum;
				...
				protected List<ShotefV04Model.GufHamimshak.YeshutGoremPoneLemislaka.PirteiHaavaratKsafim.ZihuiShemMismachBeramatEirua> zihuiShemMismachBeramatEirua;
				@XmlElement(name = "PirteiKupa")
				protected List<ShotefV04Model.GufHamimshak.YeshutGoremPoneLemislaka.PirteiHaavaratKsafim.PirteiKupa> pirteiKupa;
				...
				public String getMISPARTIKNIKUIMMAASIK() {
					return mispartiknikuimmaasik;
				}
				
				public void setMISPARTIKNIKUIMMAASIK(String value) {
					this.mispartiknikuimmaasik = value;
				}
				...
				public BigDecimal getSCHUMHAFKADAKOLEL() {
					return schumhafkadakolel;
				}

				public void setSCHUMHAFKADAKOLEL(BigDecimal value) {
					this.schumhafkadakolel = value;
				}
				...
				public String getSHEMPRATIISHKESHERMAASIK() {
					return shempratiishkeshermaasik;
				}
				
				public void setSHEMPRATIISHKESHERMAASIK(String value) {
					this.shempratiishkeshermaasik = value;
				}
				
				@Override
				public String getSHEMMISHPACHAISHKESHERMAASIK() {
					return shemmishpachaishkeshermaasik;
				}
				
				public void setSHEMMISHPACHAISHKESHERMAASIK(String value) {
					this.shemmishpachaishkeshermaasik = value;
				}
				
				@Override
				public String getMISPARTELEPHONEKAVIISHKESHERMAASIK() {
					return mispartelephonekaviishkeshermaasik;
				}
				
				public void setMISPARTELEPHONEKAVIISHKESHERMAASIK(String value) {
					this.mispartelephonekaviishkeshermaasik = value;
				}
				
				@Override
				public String getEMAILISHKESHERMAASIK() {
					return emailishkeshermaasik;
				}
				
				public void setEMAILISHKESHERMAASIK(String value) {
					this.emailishkeshermaasik = value;
				}
				
				@Override
				public String getMISPARCELLULARIISHKESHERMAASIK() {
					return misparcellulariishkeshermaasik;
				}
				
				public void setMISPARCELLULARIISHKESHERMAASIK(String value) {
					this.misparcellulariishkeshermaasik = value;
				}
				...
				@Override
				public int getSUGCHESHBONMAASIK() {
					return sugcheshbonmaasik;
				}

				public void setSUGCHESHBONMAASIK(int value) {
					this.sugcheshbonmaasik = value;
				}

				@Override
				public int getSUGCHESHBONKOLETTASHLUM() {
					return sugcheshbonkolettashlum;
				}

				public void setSUGCHESHBONKOLETTASHLUM(int value) {
				...
				@Override
				public List<ShotefV04Model.GufHamimshak.YeshutGoremPoneLemislaka.PirteiHaavaratKsafim.ZihuiShemMismachBeramatEirua> getZihuiShemMismachBeramatEirua() {
					if (zihuiShemMismachBeramatEirua == null) {
						zihuiShemMismachBeramatEirua = new ArrayList<ShotefV04Model.GufHamimshak.YeshutGoremPoneLemislaka.PirteiHaavaratKsafim.ZihuiShemMismachBeramatEirua>();
					}
					return this.zihuiShemMismachBeramatEirua;
				}

				@Override
				public List<ShotefV04Model.GufHamimshak.YeshutGoremPoneLemislaka.PirteiHaavaratKsafim.PirteiKupa> getPirteiKupa() {
					if (pirteiKupa == null) {
						pirteiKupa = new ArrayList<ShotefV04Model.GufHamimshak.YeshutGoremPoneLemislaka.PirteiHaavaratKsafim.PirteiKupa>();
					}
				...
				public static class PirteiKupa implements PirteiKupaBase {
					...
					protected List<ShotefV04Model.GufHamimshak.YeshutGoremPoneLemislaka.PirteiHaavaratKsafim.PirteiKupa.PirteiOved> pirteiOved;
					...
					@Override
					public List<ShotefV04Model.GufHamimshak.YeshutGoremPoneLemislaka.PirteiHaavaratKsafim.PirteiKupa.PirteiOved> getPirteiOved() {
						if (pirteiOved == null) {
							pirteiOved = new ArrayList<ShotefV04Model.GufHamimshak.YeshutGoremPoneLemislaka.PirteiHaavaratKsafim.PirteiKupa.PirteiOved>();
						}
					...
					public static class PirteiOved implements PirteiOvedBase {
						...
						@XmlElement(name = "MISPAR-DIRA", required = true, nillable = true)
						protected Integer mispardira;
						@XmlElement(name = "MIKUD", required = true, nillable = true)
						protected Integer mikud;
						@XmlElement(name = "TA-DOAR", required = true, nillable = true)
						protected Integer tadoar;
						@XmlElement(name = "E-MAIL", required = true)
						protected String email;
						@XmlElement(name = "MISPAR-CELLULARI", required = true)
						protected String misparcellulari;
						@XmlElement(name = "MIN", required = true, nillable = true)
						protected Integer min;
						@XmlElement(name = "MOED-TCHILAT-AHASAKAT-OVED", required = true, nillable = true)
						protected String moedtchilatahasakatoved;
						@XmlElement(name = "HASHAVA-KIBUTZI", required = true, nillable = true)
						protected Integer hashavakibutzi;
						@XmlElement(name = "HATZHARAT-OVED", required = true, nillable = true)
						protected Integer hatzharatoved;
						@XmlElement(name = "SEIF-ARBA-ESRE-LAOVED", required = true, nillable = true)
						protected Integer seifarbaesrelaoved;
						@XmlElement(name = "ChodeshMaskoretVestatusOved", required = true)
						protected List<ShotefV04Model.GufHamimshak.YeshutGoremPoneLemislaka.PirteiHaavaratKsafim.PirteiKupa.PirteiOved.ChodeshMaskoretVestatusOved> chodeshMaskoretVestatusOved;
						...
						public void setShemyeshuv(String shemyeshuv) {
							this.shemyeshuv = shemyeshuv;
						}
						...
						public void setShemrechov(String shemrechov) {
							this.shemrechov = shemrechov;
						}
						...
						public void setMisparbait(String misparbait) {
							this.misparbait = misparbait;
						}
						...
						public void setMispardira(Integer mispardira) {
							this.mispardira = mispardira;
						}
						...
						public void setMikud(Integer mikud) {
							this.mikud = mikud;
						}
						...
						public void setTadoar(Integer tadoar) {
							this.tadoar = tadoar;
						}
						...
						public void setMisparcellulari(String misparcellulari) {
							this.misparcellulari = misparcellulari;
						}
						...
						public String getMoedtchilatahasakatoved() {
							return moedtchilatahasakatoved;
						}

						public void setMoedtchilatahasakatoved(String moedtchilatahasakatoved) {
							this.moedtchilatahasakatoved = moedtchilatahasakatoved;
						}
						
						@Override
						public Integer getHASHAVAKIBUTZI() {
							return hashavakibutzi;
						}
						
						public void setMoedtchilatahasakatoved(Integer value) {
							this.hashavakibutzi = value;
						}
						
						@Override
						public Integer getHATZHARATOVED() {
							return hatzharatoved;
						}
						
						public void setHATZHARATOVED(Integer value) {
							this.hatzharatoved = value;
						}
						
						@Override
						public Integer getSEIFARBAESRELAOVED() {
							return seifarbaesrelaoved;
						}
						
						public void setSEIFARBAESRELAOVED(Integer value) {
							this.seifarbaesrelaoved = value;
						}
						
						@Override
						public List<ShotefV04Model.GufHamimshak.YeshutGoremPoneLemislaka.PirteiHaavaratKsafim.PirteiKupa.PirteiOved.ChodeshMaskoretVestatusOved> getChodeshMaskoretVestatusOved() {
							if (chodeshMaskoretVestatusOved == null) {
								chodeshMaskoretVestatusOved = new ArrayList<ShotefV04Model.GufHamimshak.YeshutGoremPoneLemislaka.PirteiHaavaratKsafim.PirteiKupa.PirteiOved.ChodeshMaskoretVestatusOved>();
							}
						...
						@XmlType(name = "", propOrder = { "chodeshmaskoret", "mahamadhafkadabekupa", "sugtakbul",
								"rovedsachar", "sibatbakashlechzerksafim",
						...
						public static class ChodeshMaskoretVestatusOved implements ChodeshMaskoretVestatusOvedBase {
							...
							@XmlElement(name = "MAHAMAD-HAFKADA-BEKUPA")
							protected int mahamadhafkadabekupa;
							@XmlElement(name = "SUG-TAKBUL")
							protected int sugtakbul;
							@XmlElement(name = "ROVED-SACHAR", required = true, type = Integer.class)
							protected Integer rovedsachar;
							@XmlElement(name = "SIBAT-BAKASH-LECHZER-KSAFIM", required = true, type = Integer.class, nillable = true)
							protected Integer sibatbakashlechzerksafim;
							@XmlElement(name = "SACHAR-MEDUVACH", required = true, nillable = true)
							protected BigDecimal sacharmeduvach;
							@XmlElement(name = "STATUS-OVED-BECHODESH-MASKORET")
							protected int statusovedbechodeshmaskoret;
							@XmlElement(name = "TAARICH-TCHILAT-STATUS", required = true)
							...
							@XmlElement(name = "MISPAR-POLISA-O-HESHBON", nillable = true)
							protected String misparpolisaoheshbon;
							@XmlElement(name = "PizulHafrashotOvedBeKupa")
							protected List<ShotefV04Model.GufHamimshak.YeshutGoremPoneLemislaka.PirteiHaavaratKsafim.PirteiKupa.PirteiOved.ChodeshMaskoretVestatusOved.PizulHafrashotOvedBeKupa> pizulHafrashotOvedBeKupa;
							...
							@Override
							public int getMAHAMADHAFKADABEKUPA() {
								return mahamadhafkadabekupa;
							}

							public void setMAHAMADHAFKADABEKUPA(int value) {
							...
							public void setROVEDSACHAR(Integer value) {
								this.rovedsachar = value;
							}
							
							@Override
							public Integer getSIBATBAKASHLECHZERKSAFIM() {
								return sibatbakashlechzerksafim;
							}
							
							public void setSIBATBAKASHLECHZERKSAFIM(Integer value) {
								this.sibatbakashlechzerksafim = value;
							}
							...
							@Override
							public int getSTATUSOVEDBECHODESHMASKORET() {
								return statusovedbechodeshmaskoret;
							}

							public void setSTATUSOVEDBECHODESHMASKORET(int value) {
							...
							@Override
							public List<ShotefV04Model.GufHamimshak.YeshutGoremPoneLemislaka.PirteiHaavaratKsafim.PirteiKupa.PirteiOved.ChodeshMaskoretVestatusOved.PizulHafrashotOvedBeKupa> getPizulHafrashotOvedBeKupa() {
								if (pizulHafrashotOvedBeKupa == null) {
									pizulHafrashotOvedBeKupa = new ArrayList<ShotefV04Model.GufHamimshak.YeshutGoremPoneLemislaka.PirteiHaavaratKsafim.PirteiKupa.PirteiOved.ChodeshMaskoretVestatusOved.PizulHafrashotOvedBeKupa>();
								}
							...
							public static class SachHafrashaLeKupaBechodeshMaskoretOved
								...
								@XmlElement(name = "SACH-HAFRASHA-BECHODESH-MASKORET", required = true, nillable = true)
						...
						public static class SachHafrashaLeOvedBekupa implements SachHafrashaLeOvedBekupaBase {
							...
							@XmlElement(name = "SACH-HAFRASHA-LEOVED-BEKUPA", required = true, nillable = true)
					...
					public static class SachHafrashaLeKupaMaasik implements SachHafrashaLeKupaMaasikBase {
						...
						@XmlElement(name = "SACH-HAFRASHA-LEKUPA-BERAMAT-MAASIK", required = true, nillable = true)
						protected BigDecimal sachhafrashalekupaberamatmaasik;
						@XmlElement(name = "SACH-HAFKADA-LEKUPA-BERAMAT-MAASIK", required = true, nillable = true)
						protected BigDecimal sachhafkadalekupaberamatmaasik;
						@XmlElement(name = "MISPAR-AMITIM-BERAMAT-MAASIK", required = true, nillable = true)
						protected Integer misparamitimberamatmaasik;
	...
	public static class KoteretKovetz implements KoteretKovetzBase {
		...
		@Override
		public String toString() {
			return MoreObjects.toStringHelper(this).add("sugmimshak", sugmimshak)
					.add("mispargirsatxml", mispargirsatxml).add("taarichbitzua", taarichbitzua)
					.add("kodsvivatavoda", kodsvivatavoda).add("misparhakovetz", misparhakovetz)
					.add("misparsiduri", misparsiduri).add("netuneiGoremSholech", netuneiGoremSholech)
					.add("netuneiGoremNimaan", netuneiGoremNimaan).toString();
		}
		...
		public static class NetuneiGoremNimaan implements NetuneiGoremNimaanBase {
			...
			@Override
			public String toString() {
				return MoreObjects.toStringHelper(this).add("kodnimaan", kodnimaan)
						.add("sugmezahenimaan", sugmezahenimaan).add("misparzihuinimaan", misparzihuinimaan)
						.add("misparzihuietzelyatzrannimaan", misparzihuietzelyatzrannimaan).toString();
			}
	...
	public static class ReshumatSgira implements ReshumatSgiraBase {
		...
		@Override
		public String toString() {
			return MoreObjects.toStringHelper(this).add("misparkupotyatzranimbakovetz", misparkupotyatzranimbakovetz)
					.add("misparmaasikim", misparmaasikim).add("misparreshumot", misparreshumot)
					.add("misparamitim", misparamitim).add("sachhafrashotbakovetz", sachhafrashotbakovetz)
					.add("sachhafkadotbakovetz", sachhafkadotbakovetz).toString();
		}
