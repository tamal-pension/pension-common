...
public class NegativeV03Model implements NegativeModel {

	@XmlElement(name = "KoteretKovetz", required = true)
	protected NegativeV03Model.KoteretKovetz koteretKovetz;
	@XmlElement(name = "GufHamimshak", required = true)
	protected GufHamimshak gufHamimshak;
	@XmlElement(name = "ReshumatSgira", required = true)
	protected NegativeV03Model.ReshumatSgira reshumatSgira;

	@Override
	public NegativeV03Model.KoteretKovetz getKoteretKovetz() {
		return koteretKovetz;
	}

	public void setKoteretKovetz(NegativeV03Model.KoteretKovetz value) {
	...
	@Override
	public NegativeV03Model.ReshumatSgira getReshumatSgira() {
		return reshumatSgira;
	}

	public void setReshumatSgira(NegativeV03Model.ReshumatSgira value) {
	...
	public static class GufHamimshak implements GufHamimshakBase {
		...
		protected List<NegativeV03Model.GufHamimshak.YeshutGoremPoneLemislaka> yeshutGoremPoneLemislaka;

		@Override
		public List<NegativeV03Model.GufHamimshak.YeshutGoremPoneLemislaka> getYeshutGoremPoneLemislaka() {
			if (yeshutGoremPoneLemislaka == null) {
				yeshutGoremPoneLemislaka = new ArrayList<NegativeV03Model.GufHamimshak.YeshutGoremPoneLemislaka>();
			}
		...
		public static class YeshutGoremPoneLemislaka implements YeshutGoremPoneLemislakaBase {
			...
			protected List<NegativeV03Model.GufHamimshak.YeshutGoremPoneLemislaka.PirteiHaavaratKsafim> pirteiHaavaratKsafim;
			...
			@Override
			public List<NegativeV03Model.GufHamimshak.YeshutGoremPoneLemislaka.PirteiHaavaratKsafim> getPirteiHaavaratKsafim() {
				if (pirteiHaavaratKsafim == null) {
					pirteiHaavaratKsafim = new ArrayList<NegativeV03Model.GufHamimshak.YeshutGoremPoneLemislaka.PirteiHaavaratKsafim>();
				}
			...
			public static class PirteiHaavaratKsafim implements PirteiHaavaratKsafimBase {
				...
				protected List<NegativeV03Model.GufHamimshak.YeshutGoremPoneLemislaka.PirteiHaavaratKsafim.ZihuiShemMismachBeramatEirua> zihuiShemMismachBeramatEirua;
				@XmlElement(name = "PirteiKupa")
				protected List<NegativeV03Model.GufHamimshak.YeshutGoremPoneLemislaka.PirteiHaavaratKsafim.PirteiKupa> pirteiKupa;
				...
				@Override
				public List<NegativeV03Model.GufHamimshak.YeshutGoremPoneLemislaka.PirteiHaavaratKsafim.ZihuiShemMismachBeramatEirua> getZihuiShemMismachBeramatEirua() {
					if (zihuiShemMismachBeramatEirua == null) {
						zihuiShemMismachBeramatEirua = new ArrayList<NegativeV03Model.GufHamimshak.YeshutGoremPoneLemislaka.PirteiHaavaratKsafim.ZihuiShemMismachBeramatEirua>();
					}
					return this.zihuiShemMismachBeramatEirua;
				}

				@Override
				public List<NegativeV03Model.GufHamimshak.YeshutGoremPoneLemislaka.PirteiHaavaratKsafim.PirteiKupa> getPirteiKupa() {
					if (pirteiKupa == null) {
						pirteiKupa = new ArrayList<NegativeV03Model.GufHamimshak.YeshutGoremPoneLemislaka.PirteiHaavaratKsafim.PirteiKupa>();
					}
				...
				public static class PirteiKupa implements PirteiKupaBase {
					...
					protected List<NegativeV03Model.GufHamimshak.YeshutGoremPoneLemislaka.PirteiHaavaratKsafim.PirteiKupa.PirteiOved> pirteiOved;
					...
					@Override
					public List<NegativeV03Model.GufHamimshak.YeshutGoremPoneLemislaka.PirteiHaavaratKsafim.PirteiKupa.PirteiOved> getPirteiOved() {
						if (pirteiOved == null) {
							pirteiOved = new ArrayList<NegativeV03Model.GufHamimshak.YeshutGoremPoneLemislaka.PirteiHaavaratKsafim.PirteiKupa.PirteiOved>();
						}
					...
					public static class PirteiOved implements PirteiOvedBase {
						...
						protected List<NegativeV03Model.GufHamimshak.YeshutGoremPoneLemislaka.PirteiHaavaratKsafim.PirteiKupa.PirteiOved.ChodeshMaskoretVestatusOved> chodeshMaskoretVestatusOved;
						...
						@Override
						public List<NegativeV03Model.GufHamimshak.YeshutGoremPoneLemislaka.PirteiHaavaratKsafim.PirteiKupa.PirteiOved.ChodeshMaskoretVestatusOved> getChodeshMaskoretVestatusOved() {
							if (chodeshMaskoretVestatusOved == null) {
								chodeshMaskoretVestatusOved = new ArrayList<NegativeV03Model.GufHamimshak.YeshutGoremPoneLemislaka.PirteiHaavaratKsafim.PirteiKupa.PirteiOved.ChodeshMaskoretVestatusOved>();
							}
						...
						public static class ChodeshMaskoretVestatusOved implements ChodeshMaskoretVestatusOvedBase {
							...
							protected List<NegativeV03Model.GufHamimshak.YeshutGoremPoneLemislaka.PirteiHaavaratKsafim.PirteiKupa.PirteiOved.ChodeshMaskoretVestatusOved.PizulHafrashotOvedBeKupa> pizulHafrashotOvedBeKupa;
							...
							@Override
							public List<NegativeV03Model.GufHamimshak.YeshutGoremPoneLemislaka.PirteiHaavaratKsafim.PirteiKupa.PirteiOved.ChodeshMaskoretVestatusOved.PizulHafrashotOvedBeKupa> getPizulHafrashotOvedBeKupa() {
								if (pizulHafrashotOvedBeKupa == null) {
									pizulHafrashotOvedBeKupa = new ArrayList<NegativeV03Model.GufHamimshak.YeshutGoremPoneLemislaka.PirteiHaavaratKsafim.PirteiKupa.PirteiOved.ChodeshMaskoretVestatusOved.PizulHafrashotOvedBeKupa>();
								}
	...
	public static class KoteretKovetz implements KoteretKovetzBase {
		...
		protected NegativeV03Model.KoteretKovetz.NetuneiGoremSholech netuneiGoremSholech;
		@XmlElement(name = "NetuneiGoremNimaan", required = true)
		protected NegativeV03Model.KoteretKovetz.NetuneiGoremNimaan netuneiGoremNimaan;
		...
		public NegativeV03Model.KoteretKovetz.NetuneiGoremSholech getNetuneiGoremSholech() {
			return netuneiGoremSholech;
		}

		public void setNetuneiGoremSholech(NegativeV03Model.KoteretKovetz.NetuneiGoremSholech value) {
			this.netuneiGoremSholech = value;
		}

		public NegativeV03Model.KoteretKovetz.NetuneiGoremNimaan getNetuneiGoremNimaan() {
			return netuneiGoremNimaan;
		}

		public void setNetuneiGoremNimaan(NegativeV03Model.KoteretKovetz.NetuneiGoremNimaan value) {
