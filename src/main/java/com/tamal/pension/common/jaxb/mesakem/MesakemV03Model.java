...
public class MesakemV03Model implements MesakemModel {

	@XmlElement(name = "KoteretKovetz", required = true)
	protected MesakemV03Model.KoteretKovetz koteretKovetz;
	...
	@Override
	public MesakemV03Model.KoteretKovetz getKoteretKovetz() {
		return koteretKovetz;
	}

	public void setKoteretKovetz(MesakemV03Model.KoteretKovetz value) {
	...
	public static class GufHamimshak implements GufHamimshakBase {
		...
		protected List<MesakemV03Model.GufHamimshak.YeshutGoremPoneLemislaka> yeshutGoremPoneLemislaka;

		@Override
		public List<MesakemV03Model.GufHamimshak.YeshutGoremPoneLemislaka> getYeshutGoremPoneLemislaka() {
			if (yeshutGoremPoneLemislaka == null) {
				yeshutGoremPoneLemislaka = new ArrayList<MesakemV03Model.GufHamimshak.YeshutGoremPoneLemislaka>();
			}
		...
		public static class YeshutGoremPoneLemislaka implements YeshutGoremPoneLemislakaBase {
			...
			protected List<MesakemV03Model.GufHamimshak.YeshutGoremPoneLemislaka.StatosPirteiHaavaratKsafim> statosPirteiHaavaratKsafim;
			...
			@Override
			public List<MesakemV03Model.GufHamimshak.YeshutGoremPoneLemislaka.StatosPirteiHaavaratKsafim> getStatosPirteiHaavaratKsafim() {
				if (statosPirteiHaavaratKsafim == null) {
					statosPirteiHaavaratKsafim = new ArrayList<MesakemV03Model.GufHamimshak.YeshutGoremPoneLemislaka.StatosPirteiHaavaratKsafim>();
				}
			...
			public static class StatosPirteiHaavaratKsafim implements StatosPirteiHaavaratKsafimBase {
				...
				protected List<MesakemV03Model.GufHamimshak.YeshutGoremPoneLemislaka.StatosPirteiHaavaratKsafim.PirteiOved> pirteiOved;
				...
				@Override
				public List<MesakemV03Model.GufHamimshak.YeshutGoremPoneLemislaka.StatosPirteiHaavaratKsafim.PirteiOved> getPirteiOved() {
					if (pirteiOved == null) {
						pirteiOved = new ArrayList<MesakemV03Model.GufHamimshak.YeshutGoremPoneLemislaka.StatosPirteiHaavaratKsafim.PirteiOved>();
					}
				...
				public static class PirteiOved implements PirteiOvedBase {
					...
					protected List<MesakemV03Model.GufHamimshak.YeshutGoremPoneLemislaka.StatosPirteiHaavaratKsafim.PirteiOved.StatosPirteiKlitatReshuma> statosPirteiKlitatReshuma;
					...
					@Override
					public List<MesakemV03Model.GufHamimshak.YeshutGoremPoneLemislaka.StatosPirteiHaavaratKsafim.PirteiOved.StatosPirteiKlitatReshuma> getStatosPirteiKlitatReshuma() {
						if (statosPirteiKlitatReshuma == null) {
							statosPirteiKlitatReshuma = new ArrayList<MesakemV03Model.GufHamimshak.YeshutGoremPoneLemislaka.StatosPirteiHaavaratKsafim.PirteiOved.StatosPirteiKlitatReshuma>();
						}
					...
					public static class StatosPirteiKlitatReshuma implements StatosPirteiKlitatReshumaBase {
						...
						protected List<MesakemV03Model.GufHamimshak.YeshutGoremPoneLemislaka.StatosPirteiHaavaratKsafim.PirteiOved.StatosPirteiKlitatReshuma.OfenRishumZchuiot> ofenRishumZchuiot;
						...
						@Override
						public List<MesakemV03Model.GufHamimshak.YeshutGoremPoneLemislaka.StatosPirteiHaavaratKsafim.PirteiOved.StatosPirteiKlitatReshuma.OfenRishumZchuiot> getOfenRishumZchuiot() {
							if (ofenRishumZchuiot == null) {
								ofenRishumZchuiot = new ArrayList<MesakemV03Model.GufHamimshak.YeshutGoremPoneLemislaka.StatosPirteiHaavaratKsafim.PirteiOved.StatosPirteiKlitatReshuma.OfenRishumZchuiot>();
							}
	...
	public static class KoteretKovetz implements KoteretKovetzBase {
		...
		protected MesakemV03Model.KoteretKovetz.NetuneiGoremSholech netuneiGoremSholech;
		@XmlElement(name = "NetuneiGoremNimaan", required = true)
		protected MesakemV03Model.KoteretKovetz.NetuneiGoremNimaan netuneiGoremNimaan;
		...
		public MesakemV03Model.KoteretKovetz.NetuneiGoremSholech getNetuneiGoremSholech() {
			return netuneiGoremSholech;
		}

		public void setNetuneiGoremSholech(MesakemV03Model.KoteretKovetz.NetuneiGoremSholech value) {
			this.netuneiGoremSholech = value;
		}

		public MesakemV03Model.KoteretKovetz.NetuneiGoremNimaan getNetuneiGoremNimaan() {
			return netuneiGoremNimaan;
		}

		public void setNetuneiGoremNimaan(MesakemV03Model.KoteretKovetz.NetuneiGoremNimaan value) {
