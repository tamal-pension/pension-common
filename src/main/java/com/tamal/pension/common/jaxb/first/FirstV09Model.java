...
public class FirstV09Model implements FirstModel {
	...
	public void setKoteretKovetz(FirstV09Model.KoteretKovetz value) {
	...
	public static class GufHamimshak implements GufHamimshakBase {
		...
		protected List<FirstV09Model.GufHamimshak.YeshutGoremPoneLemislaka> yeshutGoremPoneLemislaka;

		@Override
		public List<FirstV09Model.GufHamimshak.YeshutGoremPoneLemislaka> getYeshutGoremPoneLemislaka() {
			if (yeshutGoremPoneLemislaka == null) {
				yeshutGoremPoneLemislaka = new ArrayList<FirstV09Model.GufHamimshak.YeshutGoremPoneLemislaka>();
			}
		...
		public static class YeshutGoremPoneLemislaka implements YeshutGoremPoneLemislakaBase {
			...
			protected List<FirstV09Model.GufHamimshak.YeshutGoremPoneLemislaka.SugMashov> sugMashov;
			...
			@Override
			public List<FirstV09Model.GufHamimshak.YeshutGoremPoneLemislaka.SugMashov> getSugMashov() {
				if (sugMashov == null) {
					sugMashov = new ArrayList<FirstV09Model.GufHamimshak.YeshutGoremPoneLemislaka.SugMashov>();
				}
			...
			public static class SugMashov implements SugMashovBase {
				...
				protected List<FirstV09Model.GufHamimshak.YeshutGoremPoneLemislaka.SugMashov.MashovBeramatReshuma> mashovBeramatReshuma;
				...
				@Override
				public List<FirstV09Model.GufHamimshak.YeshutGoremPoneLemislaka.SugMashov.MashovBeramatReshuma> getMashovBeramatReshuma() {
					if (mashovBeramatReshuma == null) {
						mashovBeramatReshuma = new ArrayList<FirstV09Model.GufHamimshak.YeshutGoremPoneLemislaka.SugMashov.MashovBeramatReshuma>();
					}
				...
				public static class MashovBeramatKovetz implements MashovBeramatKovetzBase {
					...
					protected List<FirstV09Model.GufHamimshak.YeshutGoremPoneLemislaka.SugMashov.MashovBeramatKovetz.PerutShgihaBeramatKovetz> perutShgihaBeramatKovetz;
					...
					@Override
					public List<FirstV09Model.GufHamimshak.YeshutGoremPoneLemislaka.SugMashov.MashovBeramatKovetz.PerutShgihaBeramatKovetz> getPerutShgihaBeramatKovetz() {
						if (perutShgihaBeramatKovetz == null) {
							perutShgihaBeramatKovetz = new ArrayList<FirstV09Model.GufHamimshak.YeshutGoremPoneLemislaka.SugMashov.MashovBeramatKovetz.PerutShgihaBeramatKovetz>();
						}
				...
				public static class MashovBeramatReshuma implements MashovBeramatReshumaBase {
					...
					protected List<FirstV09Model.GufHamimshak.YeshutGoremPoneLemislaka.SugMashov.MashovBeramatReshuma.MaaneMiYazran> maaneMiYazran;
					@XmlElement(name = "PerutShgihaBeramatReshuma")
					protected List<FirstV09Model.GufHamimshak.YeshutGoremPoneLemislaka.SugMashov.MashovBeramatReshuma.PerutShgihaBeramatReshuma> perutShgihaBeramatReshuma;
					@XmlElement(name = "yipuikoach")
					protected List<FirstV09Model.GufHamimshak.YeshutGoremPoneLemislaka.SugMashov.MashovBeramatReshuma.YipuiKoach> yipuikoach;
					...
					@Override
					public List<FirstV09Model.GufHamimshak.YeshutGoremPoneLemislaka.SugMashov.MashovBeramatReshuma.MaaneMiYazran> getMaaneMiYazran() {
						if (maaneMiYazran == null) {
							maaneMiYazran = new ArrayList<FirstV09Model.GufHamimshak.YeshutGoremPoneLemislaka.SugMashov.MashovBeramatReshuma.MaaneMiYazran>();
						}
						return this.maaneMiYazran;
					}

					@Override
					public List<FirstV09Model.GufHamimshak.YeshutGoremPoneLemislaka.SugMashov.MashovBeramatReshuma.PerutShgihaBeramatReshuma> getPerutShgihaBeramatReshuma() {
						if (perutShgihaBeramatReshuma == null) {
							perutShgihaBeramatReshuma = new ArrayList<FirstV09Model.GufHamimshak.YeshutGoremPoneLemislaka.SugMashov.MashovBeramatReshuma.PerutShgihaBeramatReshuma>();
						}
					...
					public List<? extends YipuiKoachBase> getYipuiKoach(){
						if (yipuikoach == null) {
							yipuikoach = new ArrayList<FirstV09Model.GufHamimshak.YeshutGoremPoneLemislaka.SugMashov.MashovBeramatReshuma.YipuiKoach>();
						}
						return this.yipuikoach;
					}
					
					@XmlAccessorType(XmlAccessType.FIELD)
					@XmlType(name = "", propOrder = { "sugbakashatmefitzleeinianyipuikoach", "kidudmutza",
	...
	public static class KoteretKovetz implements KoteretKovetzBase {
		...
		protected FirstV09Model.KoteretKovetz.NetuneiGoremSholech netuneiGoremSholech;
		@XmlElement(name = "NetuneiGoremNimaan", required = true)
		protected FirstV09Model.KoteretKovetz.NetuneiGoremNimaan netuneiGoremNimaan;
		...
		@Override
		public FirstV09Model.KoteretKovetz.NetuneiGoremSholech getNetuneiGoremSholech() {
			return netuneiGoremSholech;
		}

		public void setNetuneiGoremSholech(FirstV09Model.KoteretKovetz.NetuneiGoremSholech value) {
			this.netuneiGoremSholech = value;
		}

		@Override
		public FirstV09Model.KoteretKovetz.NetuneiGoremNimaan getNetuneiGoremNimaan() {
			return netuneiGoremNimaan;
		}

		public void setNetuneiGoremNimaan(FirstV09Model.KoteretKovetz.NetuneiGoremNimaan value) {
