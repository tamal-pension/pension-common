...
public class ShotefV02Model implements ShotefModel {
	...
	public static class GufHamimshak implements ShotefGufHamimshak {
		...
		protected List<ShotefV02Model.GufHamimshak.YeshutGoremPoneLemislaka> yeshutGoremPoneLemislaka;

		@Override
		public List<ShotefV02Model.GufHamimshak.YeshutGoremPoneLemislaka> getYeshutGoremPoneLemislaka() {
			if (yeshutGoremPoneLemislaka == null) {
				yeshutGoremPoneLemislaka = new ArrayList<ShotefV02Model.GufHamimshak.YeshutGoremPoneLemislaka>();
			}
		...
		public static class YeshutGoremPoneLemislaka implements YeshutGoremPoneLemislakaBase {
			...
			protected List<ShotefV02Model.GufHamimshak.YeshutGoremPoneLemislaka.PirteiHaavaratKsafim> pirteiHaavaratKsafim;
			...
			@Override
			public List<ShotefV02Model.GufHamimshak.YeshutGoremPoneLemislaka.PirteiHaavaratKsafim> getPirteiHaavaratKsafim() {
				if (pirteiHaavaratKsafim == null) {
					pirteiHaavaratKsafim = new ArrayList<ShotefV02Model.GufHamimshak.YeshutGoremPoneLemislaka.PirteiHaavaratKsafim>();
				}
			...
			public static class PirteiHaavaratKsafim implements PirteiHaavaratKsafimBase {
				...
				protected int kodemtzaitashlum;
				...
				protected List<ShotefV02Model.GufHamimshak.YeshutGoremPoneLemislaka.PirteiHaavaratKsafim.ZihuiShemMismachBeramatEirua> zihuiShemMismachBeramatEirua;
				@XmlElement(name = "PirteiKupa")
				protected List<ShotefV02Model.GufHamimshak.YeshutGoremPoneLemislaka.PirteiHaavaratKsafim.PirteiKupa> pirteiKupa;
				...
				public void setKODEMTZAITASHLUM(int value) {
				...
				@Override
				public List<ShotefV02Model.GufHamimshak.YeshutGoremPoneLemislaka.PirteiHaavaratKsafim.ZihuiShemMismachBeramatEirua> getZihuiShemMismachBeramatEirua() {
					if (zihuiShemMismachBeramatEirua == null) {
						zihuiShemMismachBeramatEirua = new ArrayList<ShotefV02Model.GufHamimshak.YeshutGoremPoneLemislaka.PirteiHaavaratKsafim.ZihuiShemMismachBeramatEirua>();
					}
					return this.zihuiShemMismachBeramatEirua;
				}

				@Override
				public List<ShotefV02Model.GufHamimshak.YeshutGoremPoneLemislaka.PirteiHaavaratKsafim.PirteiKupa> getPirteiKupa() {
					if (pirteiKupa == null) {
						pirteiKupa = new ArrayList<ShotefV02Model.GufHamimshak.YeshutGoremPoneLemislaka.PirteiHaavaratKsafim.PirteiKupa>();
					}
				...
				public static class PirteiKupa implements PirteiKupaBase {
					...
					protected List<ShotefV02Model.GufHamimshak.YeshutGoremPoneLemislaka.PirteiHaavaratKsafim.PirteiKupa.PirteiOved> pirteiOved;
					...
					@Override
					public List<ShotefV02Model.GufHamimshak.YeshutGoremPoneLemislaka.PirteiHaavaratKsafim.PirteiKupa.PirteiOved> getPirteiOved() {
						if (pirteiOved == null) {
							pirteiOved = new ArrayList<ShotefV02Model.GufHamimshak.YeshutGoremPoneLemislaka.PirteiHaavaratKsafim.PirteiKupa.PirteiOved>();
						}
					...
					public static class PirteiOved implements PirteiOvedBase {
						...
						protected List<ShotefV02Model.GufHamimshak.YeshutGoremPoneLemislaka.PirteiHaavaratKsafim.PirteiKupa.PirteiOved.ChodeshMaskoretVestatusOved> chodeshMaskoretVestatusOved;
						...
						@Override
						public List<ShotefV02Model.GufHamimshak.YeshutGoremPoneLemislaka.PirteiHaavaratKsafim.PirteiKupa.PirteiOved.ChodeshMaskoretVestatusOved> getChodeshMaskoretVestatusOved() {
							if (chodeshMaskoretVestatusOved == null) {
								chodeshMaskoretVestatusOved = new ArrayList<ShotefV02Model.GufHamimshak.YeshutGoremPoneLemislaka.PirteiHaavaratKsafim.PirteiKupa.PirteiOved.ChodeshMaskoretVestatusOved>();
							}
						...
						public static class ChodeshMaskoretVestatusOved implements ChodeshMaskoretVestatusOvedBase {
							...
							@XmlElement(name = "SACHAR-MEDUVACH", required = true)
							...
							protected List<ShotefV02Model.GufHamimshak.YeshutGoremPoneLemislaka.PirteiHaavaratKsafim.PirteiKupa.PirteiOved.ChodeshMaskoretVestatusOved.PizulHafrashotOvedBeKupa> pizulHafrashotOvedBeKupa;
							...
							@Override
							public List<ShotefV02Model.GufHamimshak.YeshutGoremPoneLemislaka.PirteiHaavaratKsafim.PirteiKupa.PirteiOved.ChodeshMaskoretVestatusOved.PizulHafrashotOvedBeKupa> getPizulHafrashotOvedBeKupa() {
								if (pizulHafrashotOvedBeKupa == null) {
									pizulHafrashotOvedBeKupa = new ArrayList<ShotefV02Model.GufHamimshak.YeshutGoremPoneLemislaka.PirteiHaavaratKsafim.PirteiKupa.PirteiOved.ChodeshMaskoretVestatusOved.PizulHafrashotOvedBeKupa>();
								}
