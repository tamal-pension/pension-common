...
public class NegativeV02Model implements NegativeModel {

	@XmlElement(name = "KoteretKovetz", required = true)
	protected NegativeV02Model.KoteretKovetz koteretKovetz;
	@XmlElement(name = "GufHamimshak", required = true)
	protected GufHamimshak gufHamimshak;
	@XmlElement(name = "ReshumatSgira", required = true)
	protected NegativeV02Model.ReshumatSgira reshumatSgira;

	@Override
	public NegativeV02Model.KoteretKovetz getKoteretKovetz() {
		return koteretKovetz;
	}

	public void setKoteretKovetz(NegativeV02Model.KoteretKovetz value) {
	...
	@Override
	public NegativeV02Model.ReshumatSgira getReshumatSgira() {
		return reshumatSgira;
	}

	public void setReshumatSgira(NegativeV02Model.ReshumatSgira value) {
	...
	public static class GufHamimshak implements GufHamimshakBase {
		...
		protected List<NegativeV02Model.GufHamimshak.YeshutGoremPoneLemislaka> yeshutGoremPoneLemislaka;

		@Override
		public List<NegativeV02Model.GufHamimshak.YeshutGoremPoneLemislaka> getYeshutGoremPoneLemislaka() {
			if (yeshutGoremPoneLemislaka == null) {
				yeshutGoremPoneLemislaka = new ArrayList<NegativeV02Model.GufHamimshak.YeshutGoremPoneLemislaka>();
			}
		...
		public static class YeshutGoremPoneLemislaka implements YeshutGoremPoneLemislakaBase {
			...
			protected List<NegativeV02Model.GufHamimshak.YeshutGoremPoneLemislaka.PirteiHaavaratKsafim> pirteiHaavaratKsafim;
			...
			@Override
			public List<NegativeV02Model.GufHamimshak.YeshutGoremPoneLemislaka.PirteiHaavaratKsafim> getPirteiHaavaratKsafim() {
				if (pirteiHaavaratKsafim == null) {
					pirteiHaavaratKsafim = new ArrayList<NegativeV02Model.GufHamimshak.YeshutGoremPoneLemislaka.PirteiHaavaratKsafim>();
				}
			...
			public static class PirteiHaavaratKsafim implements PirteiHaavaratKsafimBase {
				...
				protected List<NegativeV02Model.GufHamimshak.YeshutGoremPoneLemislaka.PirteiHaavaratKsafim.ZihuiShemMismachBeramatEirua> zihuiShemMismachBeramatEirua;
				@XmlElement(name = "PirteiKupa")
				protected List<NegativeV02Model.GufHamimshak.YeshutGoremPoneLemislaka.PirteiHaavaratKsafim.PirteiKupa> pirteiKupa;
				...
				@Override
				public List<NegativeV02Model.GufHamimshak.YeshutGoremPoneLemislaka.PirteiHaavaratKsafim.ZihuiShemMismachBeramatEirua> getZihuiShemMismachBeramatEirua() {
					if (zihuiShemMismachBeramatEirua == null) {
						zihuiShemMismachBeramatEirua = new ArrayList<NegativeV02Model.GufHamimshak.YeshutGoremPoneLemislaka.PirteiHaavaratKsafim.ZihuiShemMismachBeramatEirua>();
					}
					return this.zihuiShemMismachBeramatEirua;
				}

				@Override
				public List<NegativeV02Model.GufHamimshak.YeshutGoremPoneLemislaka.PirteiHaavaratKsafim.PirteiKupa> getPirteiKupa() {
					if (pirteiKupa == null) {
						pirteiKupa = new ArrayList<NegativeV02Model.GufHamimshak.YeshutGoremPoneLemislaka.PirteiHaavaratKsafim.PirteiKupa>();
					}
				...
				public static class PirteiKupa implements PirteiKupaBase {
					...
					protected List<NegativeV02Model.GufHamimshak.YeshutGoremPoneLemislaka.PirteiHaavaratKsafim.PirteiKupa.PirteiOved> pirteiOved;
					...
					@Override
					public List<NegativeV02Model.GufHamimshak.YeshutGoremPoneLemislaka.PirteiHaavaratKsafim.PirteiKupa.PirteiOved> getPirteiOved() {
						if (pirteiOved == null) {
							pirteiOved = new ArrayList<NegativeV02Model.GufHamimshak.YeshutGoremPoneLemislaka.PirteiHaavaratKsafim.PirteiKupa.PirteiOved>();
						}
					...
					public static class PirteiOved implements PirteiOvedBase {
						...
						protected List<NegativeV02Model.GufHamimshak.YeshutGoremPoneLemislaka.PirteiHaavaratKsafim.PirteiKupa.PirteiOved.ChodeshMaskoretVestatusOved> chodeshMaskoretVestatusOved;
						...
						@Override
						public List<NegativeV02Model.GufHamimshak.YeshutGoremPoneLemislaka.PirteiHaavaratKsafim.PirteiKupa.PirteiOved.ChodeshMaskoretVestatusOved> getChodeshMaskoretVestatusOved() {
							if (chodeshMaskoretVestatusOved == null) {
								chodeshMaskoretVestatusOved = new ArrayList<NegativeV02Model.GufHamimshak.YeshutGoremPoneLemislaka.PirteiHaavaratKsafim.PirteiKupa.PirteiOved.ChodeshMaskoretVestatusOved>();
							}
						...
						public static class ChodeshMaskoretVestatusOved implements ChodeshMaskoretVestatusOvedBase {
							...
							protected List<NegativeV02Model.GufHamimshak.YeshutGoremPoneLemislaka.PirteiHaavaratKsafim.PirteiKupa.PirteiOved.ChodeshMaskoretVestatusOved.PizulHafrashotOvedBeKupa> pizulHafrashotOvedBeKupa;
							...
							@Override
							public List<NegativeV02Model.GufHamimshak.YeshutGoremPoneLemislaka.PirteiHaavaratKsafim.PirteiKupa.PirteiOved.ChodeshMaskoretVestatusOved.PizulHafrashotOvedBeKupa> getPizulHafrashotOvedBeKupa() {
								if (pizulHafrashotOvedBeKupa == null) {
									pizulHafrashotOvedBeKupa = new ArrayList<NegativeV02Model.GufHamimshak.YeshutGoremPoneLemislaka.PirteiHaavaratKsafim.PirteiKupa.PirteiOved.ChodeshMaskoretVestatusOved.PizulHafrashotOvedBeKupa>();
								}
	...
	public static class KoteretKovetz implements KoteretKovetzBase {
		...
		protected NegativeV02Model.KoteretKovetz.NetuneiGoremSholech netuneiGoremSholech;
		@XmlElement(name = "NetuneiGoremNimaan", required = true)
		protected NegativeV02Model.KoteretKovetz.NetuneiGoremNimaan netuneiGoremNimaan;
		...
		public NegativeV02Model.KoteretKovetz.NetuneiGoremSholech getNetuneiGoremSholech() {
			return netuneiGoremSholech;
		}

		public void setNetuneiGoremSholech(NegativeV02Model.KoteretKovetz.NetuneiGoremSholech value) {
			this.netuneiGoremSholech = value;
		}

		public NegativeV02Model.KoteretKovetz.NetuneiGoremNimaan getNetuneiGoremNimaan() {
			return netuneiGoremNimaan;
		}

		public void setNetuneiGoremNimaan(NegativeV02Model.KoteretKovetz.NetuneiGoremNimaan value) {
