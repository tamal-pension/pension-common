...
public class MesakemV01Model implements MesakemModel {

	@XmlElement(name = "KoteretKovetz", required = true)
	protected MesakemV01Model.KoteretKovetz koteretKovetz;
	...
	@Override
	public MesakemV01Model.KoteretKovetz getKoteretKovetz() {
		return koteretKovetz;
	}

	public void setKoteretKovetz(MesakemV01Model.KoteretKovetz value) {
	...
	public static class GufHamimshak implements GufHamimshakBase {
		...
		protected List<MesakemV01Model.GufHamimshak.YeshutGoremPoneLemislaka> yeshutGoremPoneLemislaka;

		@Override
		public List<MesakemV01Model.GufHamimshak.YeshutGoremPoneLemislaka> getYeshutGoremPoneLemislaka() {
			if (yeshutGoremPoneLemislaka == null) {
				yeshutGoremPoneLemislaka = new ArrayList<MesakemV01Model.GufHamimshak.YeshutGoremPoneLemislaka>();
			}
		...
		public static class YeshutGoremPoneLemislaka implements YeshutGoremPoneLemislakaBase {
			...
			protected List<MesakemV01Model.GufHamimshak.YeshutGoremPoneLemislaka.StatosPirteiHaavaratKsafim> statosPirteiHaavaratKsafim;
			...
			@Override
			public List<MesakemV01Model.GufHamimshak.YeshutGoremPoneLemislaka.StatosPirteiHaavaratKsafim> getStatosPirteiHaavaratKsafim() {
				if (statosPirteiHaavaratKsafim == null) {
					statosPirteiHaavaratKsafim = new ArrayList<MesakemV01Model.GufHamimshak.YeshutGoremPoneLemislaka.StatosPirteiHaavaratKsafim>();
				}
			...
			public static class StatosPirteiHaavaratKsafim implements StatosPirteiHaavaratKsafimBase {
				...
				protected List<MesakemV01Model.GufHamimshak.YeshutGoremPoneLemislaka.StatosPirteiHaavaratKsafim.PirteiOved> pirteiOved;
				...
				@Override
				public List<MesakemV01Model.GufHamimshak.YeshutGoremPoneLemislaka.StatosPirteiHaavaratKsafim.PirteiOved> getPirteiOved() {
					if (pirteiOved == null) {
						pirteiOved = new ArrayList<MesakemV01Model.GufHamimshak.YeshutGoremPoneLemislaka.StatosPirteiHaavaratKsafim.PirteiOved>();
					}
				...
				public static class PirteiOved implements PirteiOvedBase {
					...
					protected List<MesakemV01Model.GufHamimshak.YeshutGoremPoneLemislaka.StatosPirteiHaavaratKsafim.PirteiOved.StatosPirteiKlitatReshuma> statosPirteiKlitatReshuma;
					...
					@Override
					public List<MesakemV01Model.GufHamimshak.YeshutGoremPoneLemislaka.StatosPirteiHaavaratKsafim.PirteiOved.StatosPirteiKlitatReshuma> getStatosPirteiKlitatReshuma() {
						if (statosPirteiKlitatReshuma == null) {
							statosPirteiKlitatReshuma = new ArrayList<MesakemV01Model.GufHamimshak.YeshutGoremPoneLemislaka.StatosPirteiHaavaratKsafim.PirteiOved.StatosPirteiKlitatReshuma>();
						}
					...
					public static class StatosPirteiKlitatReshuma implements StatosPirteiKlitatReshumaBase {
						...
						protected List<MesakemV01Model.GufHamimshak.YeshutGoremPoneLemislaka.StatosPirteiHaavaratKsafim.PirteiOved.StatosPirteiKlitatReshuma.OfenRishumZchuiot> ofenRishumZchuiot;
						...
						@Override
						public List<MesakemV01Model.GufHamimshak.YeshutGoremPoneLemislaka.StatosPirteiHaavaratKsafim.PirteiOved.StatosPirteiKlitatReshuma.OfenRishumZchuiot> getOfenRishumZchuiot() {
							if (ofenRishumZchuiot == null) {
								ofenRishumZchuiot = new ArrayList<MesakemV01Model.GufHamimshak.YeshutGoremPoneLemislaka.StatosPirteiHaavaratKsafim.PirteiOved.StatosPirteiKlitatReshuma.OfenRishumZchuiot>();
							}
	...
	public static class KoteretKovetz implements KoteretKovetzBase {
		...
		protected MesakemV01Model.KoteretKovetz.NetuneiGoremSholech netuneiGoremSholech;
		@XmlElement(name = "NetuneiGoremNimaan", required = true)
		protected MesakemV01Model.KoteretKovetz.NetuneiGoremNimaan netuneiGoremNimaan;
		...
		public MesakemV01Model.KoteretKovetz.NetuneiGoremSholech getNetuneiGoremSholech() {
			return netuneiGoremSholech;
		}

		public void setNetuneiGoremSholech(MesakemV01Model.KoteretKovetz.NetuneiGoremSholech value) {
			this.netuneiGoremSholech = value;
		}

		public MesakemV01Model.KoteretKovetz.NetuneiGoremNimaan getNetuneiGoremNimaan() {
			return netuneiGoremNimaan;
		}

		public void setNetuneiGoremNimaan(MesakemV01Model.KoteretKovetz.NetuneiGoremNimaan value) {
